...
pub unsafe fn LoadLibraryA(lpLibFileName: &str) -> usize {
    let loadLibraryA: FnLoadLibraryA = core::mem::transmute(GetProcAddressInternal(
        GetModuleHandleInternal("kernel32.dll"),
        Name("LoadLibraryA"),
    ));

    loadLibraryA(lpLibFileName.as_ptr())
}
...
pub unsafe fn GetSystemDirectoryA(lpBuffer: *mut u8, uSize: u32) -> u32 {
    let getSystemDirectoryA: FnGetSystemDirectoryA = core::mem::transmute(GetProcAddressInternal(
        GetModuleHandleInternal("kernel32.dll"),
...
pub type FnGetWindowsDirectoryA = unsafe extern "system" fn(lpBuffer: *mut u8, uSize: u32) -> u32;
pub unsafe fn GetWidnowsDirectoryA(lpBuffer: *mut u8, uSize: u32) -> u32 {
    let getWindowsDirectoryA: FnGetWindowsDirectoryA = core::mem::transmute(GetProcAddressInternal(
        GetModuleHandleInternal("kernel32.dll"),
